...
urlpatterns = [
    ...
    path('comment_edit/<int:id>', views.commentEdit, name='comment_edit'),
    ...
    path('admin_recipe_edit/<int:id>', views.recipeEdit, name='recipe_edit'),
    path('admin_recipe_delete/<int:id>', views.recipeDelete, name='recipe_delete'),
